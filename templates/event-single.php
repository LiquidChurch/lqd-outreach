...
<div class="container-fluid lo-custom-container panel lo-panel-custom">
    <div class="row lo-no-margin">
        ...
        <div class="row">
            <div class="col-md-8"><span class="lo-search-heading"><?php echo $event_post->title() ?></span></div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                if (!empty($info_settings['lo_events_info_date_time']) || !isset($info_settings['lo_events_info_date_time'])) {
                    ?>
                    <div class="row">
                        <div class="col-md-5 " style="vertical-align: top;"><strong>Date & Time</strong></div>
                ...
                if (!empty($info_settings['lo_events_info_partner_organization']) || !isset($info_settings['lo_events_info_partner_organization'])) {
                    ...
                    <div class="row">
                        ...
                        while ($query->have_posts()) {
                            ...
                            global $post;
                            ?>
                            <div class="col-md-5 "><strong>Partner organization</strong></div>
                            <div class="col-md-1">&#8594</div>
                            <div class="col-md-6">
