    ...
    <div class="row lo-no-margin">
        ...
        <div class="col-md-4">
            ...
            <div class="row">
                ...
                <div class="col-md-1">&#8594</div>
                <div class="col-md-6">
					<?php echo $event_post->get_meta( $meta_prefix . 'team_lead_fname' ) ?>
					<?php echo $event_post->get_meta( $meta_prefix . 'team_lead_lname' ) ?>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-1">&#8594</div>
                <div class="col-md-6">
					<?php echo $event_post->get_meta( $meta_prefix . 'team_lead_email' ) ?>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-1">&#8594</div>
                <div class="col-md-6">
					<?php echo $event_post->get_meta( $meta_prefix . 'team_lead_phone' ) ?>
                </div>
            </div>
            <!--/team leader block-->
            <br/>
