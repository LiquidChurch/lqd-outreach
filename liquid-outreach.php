...
/**
 * Copyright (c) 2017 SurajPrGupta, Liquid Church (email : suraj.gupta@scripterz.in)
 *
...
final class Liquid_Outreach
{
    ...
    /**
     * Instance of LO_Ccb_Base_Function
     *
     * @since 0.26.0
     * @var LO_Ccb_Base_Function
     */
     ...
     */
    protected $lo_ccb_events_name_map_settings;

    /**
     * Instance of LO_Ccb_Events_Partner_Cat_Map_Settings
     *
     * @since 0.26.0
    ...
    public function __get($field)
    {
        switch ($field)
        {
            ...
            case 'lo_ccb_events_partner_cat_map_settings':
            case 'lo_ccb_events_name_map_settings':
