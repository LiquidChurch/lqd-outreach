...
/**
 * Liquid Outreach Header Element Shortcode
 *
 * @since   0.7.0
 * @package Liquid_Outreach
 */
class LO_Shortcodes_Header_Element extends LO_Shortcodes_Base
{
    ...
    {
        $this->run = new LO_Shortcodes_Header_Element_Run($plugin->lo_ccb_events,
            $plugin->lo_ccb_event_partners, $plugin->lo_ccb_event_categories);
        $this->admin = new LO_Shortcodes_Header_Element_Admin($this->run);
...
class LO_Shortcodes_Header_Element_Admin extends LO_Shortcodes_Admin_Base
{
...
class LO_Shortcodes_Header_Element_Run extends LO_Shortcodes_Run_Base
{
    ...
    public function shortcode()
    {
        ...
        $content .= LO_Template_Loader::output_template('header', $content_arr);
