<?php
/**
 * Liquid_Outreach Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_liquid_outreach_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/liquid-outreach.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_liquid_outreach_plugin' );
